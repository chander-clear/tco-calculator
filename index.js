    ...
    function calculateValueAndGenerateData() {
      ...
      if (tibInput == 0) {
        var resultDataArray = [
          ...
          ['Year One', 0,createTooltipHtml("purple-tooltip","Year One:"), 0,createTooltipHtml("purple-tooltip","Year One:"), 0 , createTooltipHtml("purple-tooltip","Year One:"),],
          ['Year Two', 0, createTooltipHtml("purple-tooltip","Year Two:"), 0,createTooltipHtml("purple-tooltip","Year two:"), 0, createTooltipHtml("purple-tooltip","Year two:")],
          ['Year Three', 0,createTooltipHtml("purple-tooltip","Year Three:"), 0,createTooltipHtml("purple-tooltip","Year three:"), 0, createTooltipHtml("purple-tooltip","Year three:")],
          ['Year Four',0,createTooltipHtml("purple-tooltip","Year Four:"),0,createTooltipHtml("purple-tooltip","Year Four:"),0, createTooltipHtml("purple-tooltip","Year Four:")],
          ['Year Five',0,createTooltipHtml("purple-tooltip","Year One:"), 0,createTooltipHtml("purple-tooltip","Year One:"),0, createTooltipHtml("purple-tooltip","Year Five:")]
        ];
