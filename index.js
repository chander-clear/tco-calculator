(function() {
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function calculateValueAndGenerateData() {
      ...
      if (tibInput == 0) {
        var resultDataArray = [
          ['Year', 'Av36p', { type: 'string', role: 'tooltip', p: { html: true } }, {type: 'number', role: 'annotation'} , 'Av64p', { type: 'string', role: 'tooltip', p: { html: true } }, {type: 'number', role: 'annotation'}, 'Lightbits', { type: 'string', role: 'tooltip', p: { html: true } }, {type: 'number', role: 'annotation'}],
          ['Year One', 0,createTooltipHtml("grey-tooltip","Year One:"), 0,0,createTooltipHtml("yellow-tooltip","Year One:"),0, 0 , createTooltipHtml("purple-tooltip","Year One:"),0],
          ['Year Two', 0, createTooltipHtml("grey-tooltip","Year Two:"), 0,0,createTooltipHtml("yellow-tooltip","Year two:"),0, 0, createTooltipHtml("purple-tooltip","Year two:"), 0],
          ['Year Three', 0,createTooltipHtml("grey-tooltip","Year Three:"),0, 0,createTooltipHtml("yellow-tooltip","Year three:"),0,0, createTooltipHtml("purple-tooltip","Year three:"), 0],
          ['Year Four',0,createTooltipHtml("grey-tooltip","Year Four:"),0,0,createTooltipHtml("yellow-tooltip","Year Four:"),0,0, createTooltipHtml("purple-tooltip","Year Four:"), 0],
          ['Year Five',0,createTooltipHtml("grey-tooltip","Year One:"),0, 0,createTooltipHtml("yellow-tooltip","Year One:"),0,0, createTooltipHtml("purple-tooltip","Year Five:"), 0]
        ];
